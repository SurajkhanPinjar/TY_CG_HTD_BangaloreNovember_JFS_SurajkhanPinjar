...
public class DoctorChangePassword extends BaseTest {
...
//	
	...
	public void patientChangePasswordTest() {
		...
		driver.findElement(By.xpath("//*[@id=\"userPassword\"]")).sendKeys("Doctor@123");
		driver.findElement(By.xpath("/html/body/app-root/app-doctor-nav/app-update-login/div/div/form/button")).click();
