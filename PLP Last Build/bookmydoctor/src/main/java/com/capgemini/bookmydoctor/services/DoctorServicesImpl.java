...
public class DoctorServicesImpl implements DoctorServices {
	...
	public boolean addDoctor(Doctor doctor) {
		...
		if (Validation.isStringOnlyAlphabet(firstName)) {
		...
		if (Validation.isStringOnlyAlphabet(lastName)) {
	...
	public boolean updateDoctor(Doctor doctor) {
		...
		if (Validation.isStringOnlyAlphabet(specialization)) {
		...
		if (Validation.isStringOnlyAlphabet(clinic)) {
