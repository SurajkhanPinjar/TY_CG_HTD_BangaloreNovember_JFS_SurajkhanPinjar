...
public class BookMyDoctorControllerAdvice {
	...
	public HistoryResponse handleHistoryException(AvailabilityException e) {
		HistoryResponse historyResponse = new HistoryResponse();
		historyResponse.setStatusCode(501);
		historyResponse.setMessage("Exception");
		historyResponse.setDescription(e.getMessage());
		return historyResponse;
	}
	
	@ExceptionHandler(ContactException.class)
	public ContactResponse handleContactException(ContactException e) {
		ContactResponse contactResponse = new ContactResponse();
		contactResponse.setStatusCode(501);
		contactResponse.setMessage("Exception");
		contactResponse.setDescription(e.getMessage());
