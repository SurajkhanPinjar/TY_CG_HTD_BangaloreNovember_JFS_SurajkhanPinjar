			...
			case 1:
				...
				while (deliveryDateLoopForSchedule == 'y') {
					...
					if (!Validation.isValidDate(schedulingDateValidation)) {
						...
						contractBean.setDeliveryDate(schedulingDateValidation);
					}  else {
				...
				try {
					if (contractorServices.sheduleContract(contractBean.getContractNo(), contractBean.getDeliveryDate(), contractBean.getStatus())) {
