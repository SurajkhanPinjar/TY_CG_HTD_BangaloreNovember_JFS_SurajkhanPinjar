...
public class SchedulerController {
	...
	public static void schedulerController() {
		...
		while (schedulerLoop == 'a') {
			...
			case 2:
				...
				try {
					if (schedulerServices.deleteScheduler(schedulerBean.getSchedulerId(),
							schedulerBean.getSchedulerPassword())) {
	...
	public static void loginScheduler() {
		...
		while (true) {
			...
			try {
				if (schedulerService.loginScheduler(schedulerBean.getSchedulerId(),
						schedulerBean.getSchedulerPassword())) {
