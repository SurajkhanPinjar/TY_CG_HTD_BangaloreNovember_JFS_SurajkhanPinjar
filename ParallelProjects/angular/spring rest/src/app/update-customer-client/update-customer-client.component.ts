...
@Component({
  selector: 'app-update-customer-client',
  templateUrl: './update-customer-client.component.html',
  styleUrls: ['./update-customer-client.component.css']
})
export class UpdateCustomerClientComponent implements OnInit {
  ...
  update(form: NgForm) {
    ...
    this.customerDetails.update(form.value).subscribe(data => {
      console.log(data);
      this.router.navigateByUrl('/get-all-customer-client');
    });
  }
