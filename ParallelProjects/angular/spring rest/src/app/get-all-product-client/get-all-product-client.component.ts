...
@Component({
  selector: 'app-get-all-product-client',
  templateUrl: './get-all-product-client.component.html',
  styleUrls: ['./get-all-product-client.component.css']
})
export class GetAllProductClientComponent implements OnInit {
